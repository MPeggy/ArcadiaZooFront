...
export const allRoutes = [
    ...
    new Route("/signin", "Connexion/Déconnexion salariés", "/pages/auth/signin.html", ["disconnected"]),
    new Route("/signup", "Inscription", "/pages/auth/signup.html", ["disconnected"], "/js/auth/signup.js"),
    new Route("/account", "Mon compte salarié", "/pages/auth/account.html", ["admin", "véto", "employé"]),
    new Route("/galerie", "Galerie", "/pages/galerie.html", []),
    new Route("/editPassword", "Changer de mot de passe", "/pages/auth/editPassword.html", []),
    new Route("/ensavoirplus", "En savoir plus", "/pages/ensavoirplus", []),
